...
FROM mlocati/php-extension-installer:2.1.10 as php_ext_installer
...
COPY --from=php_ext_installer /usr/bin/install-php-extensions /usr/bin/install-php-extensions

...
FROM etriasnl/php-extensions:8.1-bullseye-gd-2 as module_gd
FROM etriasnl/php-extensions:8.1-bullseye-gearman-2.1.0 as module_gearman
FROM etriasnl/php-extensions:8.1-bullseye-gmagick-2.0.6rc1-1.3.38-2 as module_gmagick
...
FROM etriasnl/php-extensions:8.1-bullseye-zip-0 as module_zip
